...
SAMPLE_SPREADSHEET_ID = "1AhbAOQpsJtejyR8pIxypT_B9P435t1jx9Xw1TgJwcKc"
TAB_NAME = "Sheet1"

# The ID and range of a sample spreadsheet.
# SAMPLE_SPREADSHEET_ID = os.getenv("SPREADSHEET_ID")
SAMPLE_RANGE_NAME = f'{TAB_NAME}!A2:B'
...
def main():
    ...
    try:
        ...
        for row in values:
            ...
            if len(row) >= 1:
                commenters_id.append(f'{row[0]}')
            if len(row) >= 2:
                comments.append(f'{row[1]}')
